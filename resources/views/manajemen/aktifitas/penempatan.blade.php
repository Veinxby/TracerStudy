                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap" style="gap: 15px;">
                        ...
                        <div class="d-flex align-items-center" style="gap: 8px;">
                            @if(auth()->user()->hasPermission('penempatan.create'))
                                <button class="btn btn-outline-primary btn-sm px-3 shadow-sm font-weight-bold mr-2"
                                        data-toggle="modal"
                            ...
                            @if(auth()->user()->hasPermission('penempatan.import'))
                                <button class="btn btn-outline-info btn-sm px-3 shadow-sm font-weight-bold"
                                        data-toggle="modal"
                            ...
                            <tbody>
                                @foreach($penempatan as $p)
                                    <tr>
                                        ...
                                        <td>
                                            @if($p->mahasiswa->user && $p->mahasiswa)
                                                <a href="{{ route('admin.mahasiswa.detail', $p->mahasiswa->nipd) }}"
