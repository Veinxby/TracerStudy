...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('admin.permintaan.create') }}" class="btn btn-outline-primary">
                                    <i class="fas fa-plus"></i> Tambah
                                </a>
                                <button class="btn btn-outline-info" data-toggle="modal" data-target="#modalImport">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-nowrap">
                                                {{ $p->tgl_permintaan ? \Carbon\Carbon::parse($p->tgl_permintaan)->format('d M Y') : '-' }}
                                            </td>
    ...
    <div class="modal fade" id="modalImport" tabindex="-1" role="dialog" aria-labelledby="modalImportLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form id="import-form" action="{{ route('admin.permintaan.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
